...
if __name__ == '__main__':
    ...
    if data_set=="gaze360":
        ...
        dataset=Gaze360(args.gaze360label_dir, args.gaze360image_dir, transformations, 180, 4, train=True, use_oversample = args.oversample, use_class_weights = args.class_weight)
        ...
        for epoch in range(num_epochs):
            ...
            for i, (images_gaze, labels_gaze, cont_labels_gaze, name, weight, K, _) in enumerate(train_loader_gaze):
                ...
                if args.class_weight:
                    loss_reg_pitch = apply_class_weighted_loss(pitch_predicted, label_pitch_cont_gaze, reg_criterion, weight, K)
                    loss_reg_yaw = apply_class_weighted_loss(yaw_predicted, label_yaw_cont_gaze, reg_criterion, weight, K)
                else:
