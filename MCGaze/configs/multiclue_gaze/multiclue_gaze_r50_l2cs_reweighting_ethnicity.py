_base_ = './multiclue_gaze_r50_gaze360_reweighting.py'

num_stages = 4
clip_length = 7 

custom_imports = dict(
    imports=['runners.reweight_based_runner'],  # module path to the file above
...
runner = dict(_delete_=True, type='ReweightBasedRunner', max_iters=13000) 

work_dir = './work_dirs/multiclue_gaze_r50_l2cs_reweight_exp_2'
