_base_ = './multiclue_gaze_r50_gaze360_oversample.py'
...
runner = dict(_delete_=True, type='IterBasedRunner', max_iters=19200) 

work_dir = './work_dirs/multiclue_gaze_r50_l2cs_oversample_exp_1'