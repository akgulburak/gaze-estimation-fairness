_base_ = './multiclue_gaze_r50_gaze360_classWeights.py'

num_stages = 4
clip_length = 7 

custom_imports = dict(
    imports=['runners.classweight_based_runner'],  # module path to the file above
...
data = dict(
    ...
    train=dict(_delete_=True,
        ...
        labels_file_path="labels/train_labels_merged_with_paths_ethnicities.csv",
        ),
    val=dict(
        type=dataset_type,
...
runner = dict(_delete_=True, type='ClassWeightBasedRunner', max_iters=13000) 

work_dir = './work_dirs/multiclue_gaze_r50_l2cs_classWeights_exp_2'