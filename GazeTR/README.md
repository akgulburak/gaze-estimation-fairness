...
```
uv run python -m trainer.total -s <training_model_yaml_file>
```

To test a model, you can run

```
uv run python -m tester.total -s config/train/config_gaze360.yaml -t config/test/config_gaze360.yaml -o <output_file_path> -pm <trained_model_path>
```
